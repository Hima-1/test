package com.himawan.gymstis.config;

import com.himawan.gymstis.security.JwtFilter;
...
public class SecurityConfig {
    ...
    public SecurityConfig(CustomUserDetailsService userDetailsService, JwtFilter jwtTokenFilter) {
